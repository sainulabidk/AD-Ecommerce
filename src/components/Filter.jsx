  ...
  return (
    <div className="sm:mt-12 flex sm:flex-row flex-col mt-6  sm:items-center sm:justify-between">
      ...
      <div className="ml-4 relative">
        <select className="block appearance-none font-semibold text-lg w-full bg-white border border-gray-300 text-gray-700 sm:mt-0 mt-3 py-2 px-4 pr-8 rounded-md focus:outline-none focus:border-indigo-500 focus:ring-indigo-500">
